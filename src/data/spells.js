...
const spellsList = [
  ...
  },
  {
    ...
    description: `
        ...
        <div class="bg-white/5 border-l-4 border-current p-3 italic text-white/70 text-xs">
          По вашей команде <strong>бонусным действием</strong> вы можете активировать механизм. Поршень способен двигать <strong>громосткие и тяжелые объекты весом до 300кг и объемом до 25 футов</strong>.
        </div>
      `
  },
  {
    ...
    description: `
        ...
        <p class="mb-3 text-white/80 leading-relaxed font-sans italic">Вы слегка притрагиваетесь пальцами к моноклю, заставляя его модифицироваться прямо на вашем лице. Отныне <strong>ваш монокль способен смотреть сквозь стены, обнажая устройства механизмов</strong>.</p>
        <div class="bg-white/5 border-l-4 border-current p-3 italic text-white/70 text-xs">
  ...
  },
  {
    ...
    description: `
        ...
        <div class="bg-white/5 border-l-4 border-current p-3 italic text-white/70 text-xs">
          <strong>Видимость внутри сферы ограничена, вы и существа внутри не могут атаковать врагов извне.</strong> Враги снаружи не могут атаковать тех, кто находится внутри сферы. При попытки войти в сферу, будучи союзником или врагом, тот <strong>получит урон в размере 3к4</strong> и получит эффект кровотечения.
        </div>
      `
  },
  {
